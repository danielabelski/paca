...
export class PacaAPIViewsClient {
  ...
  async listTaskPositions(
    ...
    return response.items || response.taskPositions || response.positions || response.data || [];
  }
  ...
  async listCustomFieldDefinitions(
    ...
    return response.items || response.customFields || response.fields || response.data || [];
  }
